...
import {
  ...
  IconPlayerPlay, IconShield, IconFileAnalytics, IconShare, IconTool, IconRoute2,
  IconChevronLeft, IconChevronRight, IconMenuOrder, IconGripVertical, IconClipboardCheck, IconClipboardList,
...
const NAV_META = {
  ...
  locationShare: { label: 'Location Share',    icon: IconShare },
  maintenance:   { label: 'Maintenance',       icon: IconTool },
  logistics:     { label: 'Logistics',         icon: IconRoute2 },
  checklists:    { label: 'Checklists',        icon: IconClipboardCheck },
  taskDesk:      { label: 'Task Desk',         icon: IconClipboardList },
};

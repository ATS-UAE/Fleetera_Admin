...
export const vehicles: Vehicle[] = [
  {
    id: 'v-trk-001', name: 'TRK-001', plate: 'WP-CAB-1234', type: 'Heavy Truck',
  ...
  {
    id: 'v-van-023', name: 'VAN-023', plate: 'WP-ASD-5678', type: 'Van',
  ...
  {
    id: 'v-car-047', name: 'CAR-047', plate: 'CP-KDY-9012', type: 'Sedan',
  ...
  {
    id: 'v-bus-012', name: 'BUS-012', plate: 'SG-BUS-3456', type: 'Bus',
  ...
  {
    id: 'v-pkp-088', name: 'PKP-088', plate: 'NW-PKP-7890', type: 'Pickup',
  ...
  {
    id: 'v-trk-055', name: 'TRK-055', plate: 'EP-TRK-2345', type: 'Heavy Truck',
  ...
  {
    id: 'v-trk-004', name: 'TRK-004', plate: 'WP-CAC-2255', type: 'Heavy Truck',
    make: 'Volvo', model: 'FH16', year: 2022, color: '#3B82F6',
    status: VEHICLE_STATUSES.MOVING, speed: 72, fuel: 68, odometer: 142500,
    lat: 7.2906, lng: 80.6337, heading: 45,
    driverId: null, groupId: 'g1',
...
export const drivers: Driver[] = [
  {
    id: 'd-drv-001', name: 'Kasun Perera', code: 'DRV-001',
  ...
  {
    id: 'd-drv-002', name: 'Nimal Silva', code: 'DRV-002',
  ...
  {
    id: 'd-drv-003', name: 'Amal Fernando', code: 'DRV-003',
  ...
  {
    id: 'd-drv-004', name: 'Ruwan Jayasinghe', code: 'DRV-004',
  ...
  {
    id: 'd-drv-005', name: 'Chaminda Wickrama', code: 'DRV-005',
  ...
  {
    id: 'd-drv-006', name: 'Sunil Perera', code: 'DRV-006',
  ...
  {
    id: 'd-drv-007', name: 'Namal Senevirathna', code: 'DRV-007',
  ...
  {
    id: 'd-drv-008', name: 'Sahan Jayasinghe', code: 'DRV-008',
...
export const geofences: Geofence[] = [
  {
    id: 'gf-kandy-depot', name: 'Kandy Depot', type: 'circle', color: '#3B82F6',
  ...
  {
    id: 'gf-colombo-hub', name: 'Colombo Hub', type: 'polygon', color: '#10B981',
  ...
  {
    id: 'gf-restricted-a', name: 'Restricted Zone A', type: 'polygon', color: '#EF4444',
  ...
  {
    id: 'gf-fuel-station', name: 'Fuel Station Zone', type: 'circle', color: '#F59E0B',
  ...
  {
    id: 'gf-kurunegala', name: 'Kurunegala Depot', type: 'circle', color: '#3B82F6',
  ...
  {
    id: 'gf-restricted-b', name: 'Restricted Zone B', type: 'polygon', color: '#831394',
    description: 'No entry zone - Port area',
    center: { lat: 7.2906, lng: 80.6337 }, radius: 500,
    coordinates: null,
    alertOnEnter: true, alertOnExit: true,
...
export const reports = [
  {
    id: 'rpt-001', type: 'trip_summary', name: 'Daily Trip Summary',
...
export const activityFeed: ActivityItem[] = [
  { id: 'act-001', type: 'geofence_enter', vehicle: 'TRK-001', zone: 'Kandy Depot', time: '2 min ago', severity: 'info' },
  { id: 'act-002', type: 'speed_alert', vehicle: 'BUS-012', detail: 'Speed: 92 km/h', time: '8 min ago', severity: 'warning' },
  { id: 'act-003', type: 'fuel_low', vehicle: 'PKP-088', detail: 'Fuel: 15%', time: '15 min ago', severity: 'danger' },
  { id: 'act-004', type: 'geofence_exit', vehicle: 'VAN-023', zone: 'Colombo Hub', time: '22 min ago', severity: 'info' },
  { id: 'act-005', type: 'ignition_on', vehicle: 'TRK-055', time: '31 min ago', severity: 'success' },
  { id: 'act-006', type: 'maintenance_due', vehicle: 'BUS-012', detail: 'Service overdue 500km', time: '1 hr ago', severity: 'warning' },
];

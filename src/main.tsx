...
function ThemeWrapper() {
  ...
  // Mantine only supports 'light' | 'dark' — map our custom themes to the right base.
  const mantineScheme = (theme === 'light' || theme === 'corporate') ? 'light' : 'dark';
  return (
    <MantineProvider theme={mantineTheme} forceColorScheme={mantineScheme}>
      <ModalsProvider>
